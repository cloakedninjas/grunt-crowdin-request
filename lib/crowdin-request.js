...
module.exports = function(grunt) {
      ...
      case 'download':
        crowdin.export()
          ...
          .then(function () {
            ...
            var readStream = fs.createReadStream('i18n/all.zip');
            var writeStream = fstream.Writer('i18n');
  ...
  Crowdin.prototype.download = function () {
    var url = this.formUrl('download/all.zip');
  ...
  Crowdin.prototype.unzipTranslations = function (toPath) {
    console.log(toPath);
    // TODO - FIX - Zip not getting extracted, yet fs is able to write file
    return this.downloadToStream(fs.createWriteStream('all.zip'));
